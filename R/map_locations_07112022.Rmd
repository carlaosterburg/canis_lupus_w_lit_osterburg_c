...
ggsave(here::here("plots", "map_wolf_review_coordinates_year_transp.png"), 
       width = 9, height = 5, dpi = 500)

ggsave(here::here("plots", "map_wolf_review_coordinates_year_white.png"), 
...
zoom_map <- 
  ...
  scale_color_viridis_c(
    option = "viridis", direction = -1, end = .9, name = "Year of Publication", 
    guide = guide_colorsteps(
      barwidth = unit(11, "lines"), barheight = unit(.5, "lines"),
      title.position = "top", order = 1, show.limits = TRUE
    )
