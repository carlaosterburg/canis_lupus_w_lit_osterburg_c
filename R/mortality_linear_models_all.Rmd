...
lmforlossage <-glmer(mortality~(1|age_class_calc)+forloss_standard, data=mortality_forloss_ID, family="binomial")
...
lmforlossage <-glmer(mortality~(1|age_class_calc)+forloss_standard, data=survival_ID, family="binomial")
...
lmecoage <- glmer(mortality~(1|age_class_calc)+eco_standard, data=eco_mort_ID, family = "binomial")
...
lmdevtage <- glmer(mortality~(1|age_class_calc)+devt_standard,data=devthreat_mort_ID, family="binomial")
...
lmagewdpa <- glmer(mortality~(1|age_class_calc)+wdpa_standard, data=wdpa_mort_ID, family="binomial")
...
lmaccage <- glmer(mortality~(1|age_class_calc)+access_standard,data=access_mort_ID, family ="binomial")
...
lmbioage<- glmer(mortality~(1|age_class_calc)+bio_standard,data=bio_mort_ID, family="binomial")
