...
df_coords <- read_csv2(here::here("data-raw", "geo-raw", "study_coords_20_01_2023.csv"))
...
zoom_map <- 
  ...
  scale_color_viridis_c(
    ...
    guide = guide_colorsteps(
      barwidth = unit(11, "lines"), barheight = unit(.5, "lines"),
      title.position = "top", order = 1, show.limits = TRUEs
    )
  ) +
  scale_shape_manual(
    values = c(21, 23), name = "Exact Location?", labels = c("No", "Yes"),
...
ggsave(here::here("plots", "map_wolf_review_coordinates_year_EUR_transp_c_20012023.png"), 
       width = 4.5, height = 5, dpi = 500)

ggsave(here::here("plots", "map_wolf_review_coordinates_year_EUR_white_c_20012023.png"), 
       width = 4.5, height = 5, dpi = 500, bg = "white")
```
``` {r location-map}
