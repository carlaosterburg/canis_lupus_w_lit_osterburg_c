---
title: "Wolf MVP-PVA: Literature Review Maps"
description: ""
author:
    - name: "Cédric Scherer"
...
```{r data}
## rectangular data of coordinates and counts per country
df_coords <- read_csv2(here::here("data-raw", "geo-raw", "study_coords_28_02_2023.csv"))

df_coords2 <- df_coords %>% 
  na.omit()
...
world_map <-base_map + 
  ...
  scale_fill_viridis_c(
    option = "A", direction = -1, end = .9, name = "Year of Publication", 
...
ggsave(here::here("plots", "map_coords_year_h_transp_28022023.png"), 
       width = 9, height = 5, dpi = 500)

ggsave(here::here("plots", "map_coords_year_h_white_28022023.png"), 
...
zoom_map <- 
  base_map + 
  geom_sf(
    data = sf_coords, aes(shape = exact_location, color = year_pub), 
    size =1.5, stroke = .8
  ) +
...
ggsave(here::here("plots", "map_wolf_review_coordinates_year_NA_transp_c_20012023.png"), 
       width = 4.5, height = 5, dpi = 500)

ggsave(here::here("plots", "map_wolf_review_coordinates_year_NA_white_c_20012023.png"), 
...
ggsave(here::here("plots", "map_wolf_review_coordinates_year_EUR_transp_c_28022023.png"), 
       width = 4.5, height = 5, dpi = 500)

ggsave(here::here("plots", "map_wolf_review_coordinates_year_EUR_white_c_28022023.png"), 
       width = 4.5, height = 5, dpi = 500, bg = "white")
```
``` {r location-map}
